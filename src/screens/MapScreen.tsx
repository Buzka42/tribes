...
import { View, StyleSheet, Text, TouchableOpacity, ScrollView, TextInput, Alert, Platform } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  fadeRight: { position: 'absolute', right: 0, top: 0, bottom: 0, width: 30, backgroundColor: 'transparent' }, // Fade not fully supported native without SVG, transparent placeholder
